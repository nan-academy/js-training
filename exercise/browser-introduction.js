...
It's a series of exercises ment to give you a good overview of the langague and programing.
...
Once you think your solution is OK you can run the tests to verify your results.
...
// ↓ now we start the test, this mark the end of your editing zone
export const tests = [
  ...
  // to run your code just hit Ctrl+Enter, this will move to the next file !
]
